...
export const products: Product[] = [
  {
    ...
    rating: 4.8,
    reviewsCount: 1200,
    image: placeholderImg('Brown+Sugar'),
  ...
  },
  {
    ...
    rating: 4.8,
    reviewsCount: 950,
    image: placeholderImg('Mango+Fruit'),
    category: 'cat_fruit',
    isTrending: true,
  ...
  {
    id: 'p5',
    name: 'Yuzu Berry Sparkler',
    price: 199,
    rating: 4.7,
    reviewsCount: 320,
    image: placeholderImg('Yuzu+Berry'),
    category: 'cat_fruit',
    isNew: true,
    description: 'Sparkling yuzu paired with mixed berries for a tangy twist.',
    customizable: true,
  },
  {
    id: 'p6',
    ...
    rating: 4.8,
    reviewsCount: 410,
    image: placeholderImg('Lychee+Rose'),
    category: 'cat_fruit',
    isNew: true,
    description: 'Delicate rose petals infused with sweet lychee flavor.',
    customizable: true,
  },
  {
    id: 'p7',
    name: 'Pistachio Boba Latte',
    price: 219,
    rating: 4.7,
    reviewsCount: 150,
    image: placeholderImg('Pistachio'),
    category: 'cat_classic',
    isNew: true,
    description: 'Nutty pistachio cream blended with our classic boba.',
    customizable: true,
  },
  {
    id: 'p8',
    ...
    rating: 4.6,
    reviewsCount: 220,
    image: placeholderImg('Peach+Oolong'),
    category: 'cat_fruit',
    isNew: true,
    description: 'Premium oolong tea with sweet peach syrup.',
    customizable: true,
  },
  {
    id: 'p9',
    ...
    rating: 4.8,
    reviewsCount: 560,
    image: placeholderImg('Taro'),
    category: 'cat_classic',
    isNew: true,
    description: 'Creamy taro mixed with coconut milk.',
    customizable: true,
  }
];
...
export const offers: Offer[] = [
  {
    id: 'o1',
    title: 'HAPPY HOUR',
    description: '2PM - 5PM. Get 20% OFF on all drinks',
    image: placeholderImg('Happy+Hour'),
    code: 'HAPPY20',
